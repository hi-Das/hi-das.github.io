    ...
    portfolio: {
        ...
        story: {
            ...
            paragraphs: [
                ...
                "Although most of my production work has been on Azure, my compute understanding goes down to the hypervisor layer — VMware vSphere and ESXi before the cloud abstraction ever existed for me. it simply means that I can work with any cloud provider."
            ],
            principles: [
                ...
                "I am easy to work with; I tend to listen first and wait for my turn to speak",
                "I do not act like I am the smartest person in the room 😊"
            ],
            lookingFor: {
            ...
            competencies: [
                ...
                "CI/CD: GitHub Actions, Octopus Deploy, TeamCity, Jenkins",
                "Web / routing: NGINX, HAProxy, IIS, Cloudflare, Azure LB",
                "Identity: Azure AD, Active Directory, Keycloak",
                "Monitoring: LogicMonitor, PRTG, Azure Monitor",
                "Databases: SQL Server, PostgreSQL, Azure SQL, MongoDB",
        ...
        experience: [
            ...
            },
            {
                ...
                company: "Jumio Corp — identity verification for KYC and compliance",
                highlights: [
                    "Consolidated fragmented Azure subscriptions and removed orphaned resources, saving about $60k per year.",
                    "Implemented Azure AD Connect Sync to keep identity consistent across on-prem AD and Azure AD.",
                    "Rolled out LogicMonitor so on-prem and Azure systems could be observed through one monitoring path.",
            ...
            },
            {
                ...
                setup: "On-site",
                title: "IT Support Engineer",
                company: "Tech Mahindra — global IT services and enterprise technology support",
                highlights: [
                    "Handled support incidents, hardware issues, and day-to-day user requests in a high-volume enterprise environment.",
                    "Troubleshot Windows workstations, printers, network access, and application issues under SLA pressure.",
                    "Developed communication habits and operational instincts that continue to inform incident handling today."
